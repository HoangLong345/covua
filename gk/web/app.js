...
async function handleServerMessage(data) {
    switch (data.action) {
        ...
        case "update_board":
            ...
            statusEl.classList.remove("status-my-turn", "status-opponent-turn");
            
            // Thêm lớp màu mới dựa trên lượt đi
            if (isMyTurn) {
                statusEl.classList.add("status-my-turn");
            } else {
                statusEl.classList.add("status-opponent-turn");
            }
